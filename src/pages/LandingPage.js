    ...
    <div className="lp">
      ...
      <section className="lp-section alt" id="how">
        ...
        <div className="lp-steps">
          <div className="lp-step"><span>1</span> Create Account</div>
          <div className="lp-step"><span>2</span> Add Students</div>
          <div className="lp-step"><span>3</span> Track Attendance & Grades</div>
          <div className="lp-step"><span>4</span> Share Reports</div>
        </div>
      </section>
